...
export function AdminContestOverview() {
  return (
    <div className="flex flex-col gap-8">
      ...
      <div className="bg-[#141418] border border-white/5 rounded-3xl p-8 glass-card">
        <div className="flex items-center justify-between mb-8">
          <div className="flex flex-col gap-1">
            <h3 className="text-xl font-black text-white font-outfit tracking-tighter uppercase leading-none">라운드 관리</h3>
            <p className="text-[#7A7A85] text-xs font-semibold tracking-tight">대회 진행 단계를 제어합니다</p>
          </div>
          <div className="px-4 py-1.5 rounded-xl bg-neon-purple/5 border border-neon-purple/20">
            <span className="text-xs font-bold text-neon-purple tracking-tight">Round 3 진행 중</span>
          </div>
        </div>
        ...
        <div className="flex items-center justify-between p-6 bg-white/[0.02] border border-white/5 rounded-2xl">
          <p className="text-sm font-semibold text-[#7A7A85] tracking-tight">
            다음 라운드 시작 시 <span className="text-white italic tracking-tighter">현재 진행 중인 매치가 확정</span>됩니다
          </p>
      ...
      <div className="bg-[#141418] border border-white/5 rounded-3xl p-8 glass-card">
        <div className="flex items-center justify-between mb-8">
          <h3 className="text-xl font-black text-white font-outfit tracking-tighter uppercase leading-none">대기 중인 신청서</h3>
          <div className="px-3 py-1 rounded-lg bg-neon-amber/10 border border-neon-amber/20">
            <span className="text-[10px] font-black text-neon-amber tracking-tighter">7건 대기</span>
          </div>
        </div>

        <div className="flex flex-col gap-3">
          {[
            { id: '1', name: '한승우', avatar: '한', role: 'MID · 플래티넘 II', color: 'bg-indigo-600' },
            { id: '2', name: '오지훈', avatar: '오', role: 'ADC · 다이아몬드 IV', color: 'bg-emerald-600' }
          ].map((app) => (
            <div key={app.id} className="group flex items-center justify-between p-4 bg-white/[0.02] border border-white/5 rounded-2xl hover:bg-white/[0.04] hover:border-white/10 transition-all duration-300">
              <div className="flex items-center gap-4">
                ...
                <div className="flex flex-col gap-0.5">
                  ...
                  <span className="text-[11px] font-bold text-[#7A7A85] tracking-tight">{app.role}</span>
                </div>
              </div>
      ...
      <div className="bg-[#141418] border border-white/5 rounded-3xl p-8 glass-card">
        <div className="flex items-center justify-between mb-8">
          <h3 className="text-xl font-black text-white font-outfit tracking-tighter uppercase leading-none">공지사항</h3>
        ...
        <div className="p-6 bg-white/[0.02] border border-white/5 rounded-3xl hover:bg-white/[0.04] transition-all group cursor-pointer relative overflow-hidden">
          ...
          <div className="flex flex-col gap-2 relative z-10">
            <div className="flex items-center justify-between">
              <span className="text-sm font-black text-white tracking-tight group-hover:text-neon-purple transition-all">3라운드 일정 안내</span>
            ...
            <p className="text-xs font-semibold text-[#7A7A85] tracking-tight line-clamp-1 leading-relaxed">
              3라운드는 4월 2일 오후 8시 시작 예정입니다. 팀장은 반드시 디스코드 채널을 확인해주세요.
            </p>
          </div>
        </div>
      </div>
