  ...
  return (
    <header className="flex items-center justify-between px-10 py-6 border-b border-white/5 bg-[#0C0C0F]/80 backdrop-blur-md sticky top-0 z-40">
      ...
      <div className="flex items-center gap-2 text-sm font-medium">
        <span className="text-[#7A7A85] hover:text-white cursor-pointer transition-colors">
          {t('admin.contest.management')}
        </span>
      ...
      <div className="flex items-center gap-3">
        ...
        >
          ...
          <span>{t('admin.contest.force_end')}</span>
        </Button>
        ...
        >
          ...
          <span>{t('admin.contest.edit')}</span>
        </Button>
      </div>
    </header>
  );
