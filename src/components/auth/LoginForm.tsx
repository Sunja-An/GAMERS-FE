  ...
  return (
    ...
    >
      ...
      <div className="mt-10 space-y-4">
        ...
        <Button className="w-full bg-[#6EE7B7] hover:bg-[#5EEAD4] text-[#0C0C0F] font-bold h-11 mt-2">
          로그인
        </Button>
        ...
        <div className="grid grid-cols-2 gap-3">
          <Button variant="discord" className="w-full gap-2 h-11 group text-xs px-2">
